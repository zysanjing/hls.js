...
export default class BaseStreamController extends TaskLoop implements NetworkComponentAPI {
  ...
  protected _doFragLoad (frag: Fragment, details?: LevelDetails, targetBufferTime: number | null = null, progressCallback?: FragmentLoadProgressCallback): Promise<FragLoadedData | null> {
    if (!this.levels) {
    ...
    return this.fragmentLoader.load(frag, details, targetBufferTime, progressCallback)
      .catch((e: LoadError) => {
